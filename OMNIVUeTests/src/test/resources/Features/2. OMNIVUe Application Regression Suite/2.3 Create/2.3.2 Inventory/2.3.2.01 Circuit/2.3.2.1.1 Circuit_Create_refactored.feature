  ...
  And I verify "Circuit edit Successfully-message should be displayed in the circuit page"
	...
	Then I validate Circuit in Database
		...
		##############################################################################################################################################
		 ...
		 @Create_Ethernet_Circuit @TC119152_ref @TC122362 @Delete_Ethernet_Circuit @GETENF-5090
Scenario: @TC119152 -NIC_Ethernet_Reg-Verify the functionality of Create Button for the Circuit type - Ethernet Bearer Circuit
    Given I am logged in as a "Admin" user in Omnivue   
    When I click on "Create" tab
    And I go to "Inventory" type and select "Circuit"
              And I select "Ethernet Bearer" as the Circuit type in Create Tab
              ...
              @Create_Lag @TC39237_ref @TC122366
Scenario: @TC39237 -NIC_Ethernet_Reg-Verify the functionality of Create Button for the Circuit type - LAG
    Given I am logged in as a "Admin" user in Omnivue   
    When I click on "Create" tab
    And I go to "Inventory" type and select "Circuit"
              And I select "LAG" as the Circuit type in Create Tab
