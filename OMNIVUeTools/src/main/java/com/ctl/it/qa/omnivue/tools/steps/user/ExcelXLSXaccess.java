...
public class ExcelXLSXaccess {
	...
	static ExcelXLSXaccess datatable;
	

	public ExcelXLSXaccess(String path) {
	...
	//return all sheet count
		public static int getAllSheetCount(String filePath){
			//ExcelXLSXaccess datatable = new ExcelXLSXaccess(filePath);
			int sheetCount = workbook.getActiveSheetIndex();
			return sheetCount+1;
  ...
  // find whether sheets exists	
	...
	public static boolean copySheet(String sheetName, String fromFile, String toFile){		
		...
		try {
			...
			ExcelXLSXaccess datatable = null;
			 datatable = new ExcelXLSXaccess(tempFile);
